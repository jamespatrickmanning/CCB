...
axes[1,0].text(lon[5]-0.05,lat[5]-0.03,news[5])
axes[1,0].text(lon[6]-0.05,lat[6]+0.03,news[6])
...
plt.show()
plt.savefig('speedwind&SST.png',dpi=100,bbox_inches="tight")
plt.savefig('Figure10.ps',dpi=100,bbox_inches="tight")
plt.savefig('Figure10.eps',dpi=400,bbox_inches="tight")
