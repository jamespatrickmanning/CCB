...
Last Updated: 12 Dec 2018 by JiM where he:
...
Note: Uses Linux "convert" so the final step might have to be done on a machine with that installed like NOVA
...
lat_w,lon_w=42.0,-70.3 # base of wind vector
